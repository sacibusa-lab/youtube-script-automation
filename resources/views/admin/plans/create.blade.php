                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input type="number" name="monthly_voice_tokens" value="1000" required class="w-full bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl px-5 py-4 text-gray-950 dark:text-white font-bold focus:border-teal-500 ring-0">
                                </div>
                                <div>
                                    <label class="block text-[10px] text-gray-400 font-bold uppercase mb-1.5 px-1">Voice Credit Cost (per scene)</label>
                                    <input type="number" name="voice_token_cost" value="50" required class="w-full bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl px-5 py-4 text-gray-950 dark:text-white font-bold focus:border-teal-500 ring-0">
                                </div>
                            </div>
                        </div>
                    </div>
